...
public class MainRansac {
    ...
    public static ArrayList<Point> obtentionCoins(Bitmap imageGrise) {
        ...
        ArrayList<Point> data1 = obtenirPointsHorizontaux(imageGrise,0,imageGrise.getWidth(),0,67);
        Ransac ransac1 = new Ransac(fitting,data1,1);
        horizontale1 = appliquerRansac(ransac1,imageGrise);

        ArrayList<Point> data2 = obtenirPointsHorizontaux(imageGrise,0,imageGrise.getWidth(),150,200);
        Ransac ransac2 = new Ransac(fitting,data2,1);
        horizontale2 = appliquerRansac(ransac2,imageGrise);


        ArrayList<Point> data3 = obtenirPointsVerticaux(imageGrise,0,75,0,imageGrise.getHeight());
        Ransac ransac3 = new Ransac(fitting,data3,1);
        verticale1 = appliquerRansac(ransac3,imageGrise);

        ArrayList<Point> data4 = obtenirPointsVerticaux(imageGrise,250,312,0,imageGrise.getHeight());
