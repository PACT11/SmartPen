...
public class MainRansac {
  ...
  public static void main(String[] argv) throws Exception {
    ...
    String fichierSortie = "sansmain-ransac";
	...
	private static BufferedImage mettreDroite(BufferedImage imageOriginale) {
        ...
        ArrayList<Point> data1 = obtenirPoints(imageGrise,0,imageOriginale.getWidth(),0,1000);
        Ransac ransac1 = new Ransac(fitting,data1,1);
        horizontale1 = appliquerRansac(ransac1); 
        g2d.draw(horizontale1);
        
        ArrayList<Point> data2 = obtenirPoints(imageGrise,0,imageOriginale.getWidth(),2080,2500);
        ...
        ArrayList<Point> data4 = obtenirPoints(imageGrise,1500,1900,0,imageOriginale.getHeight());
