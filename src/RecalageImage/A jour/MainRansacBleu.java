...
public class MainRansacBleu {
  public static BufferedImage imageOriginale,imageRansac;
  
  public ArrayList<Point> donnerCoinsBleus() throws Exception {
    //on ouvre le fichier de l'image en couleur
    File fichierOriginal = new File("imagebleue.jpg");
    imageOriginale = ImageIO.read(fichierOriginal);

    return ObtentionCoins(imageOriginale);
  }
